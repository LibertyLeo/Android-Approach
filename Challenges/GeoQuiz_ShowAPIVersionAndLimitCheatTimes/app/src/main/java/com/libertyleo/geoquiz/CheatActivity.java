...
import org.w3c.dom.Text;
 ...
 public class CheatActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_ANSWER_CHEAT = "com.libertyleo.geoquiz.answer_cheat";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mCheatAnswer = savedInstanceState.getString(EXTRA_ANSWER_CHEAT);
        ...
        mAPIVersionTextView.setText(String.format("APILevel %d", Build.VERSION.SDK_INT));
    }
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putString(EXTRA_ANSWER_CHEAT, mCheatAnswer);
    }
}
